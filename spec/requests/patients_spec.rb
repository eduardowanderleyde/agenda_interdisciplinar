...
RSpec.describe "/patients", type: :request do
  ...
  let(:admin) { User.create!(email: 'admin@teste.com', password: '123456', role: :admin) }
  let(:prof) { User.create!(email: 'prof@teste.com', password: '123456', role: :profissional) }
  ...
  it 'permite acesso ao admin' do
    sign_in admin
    get patients_path
    expect(response).to be_successful
  end

  it 'nega acesso ao profissional' do
    sign_in prof
    get patients_path
    expect(response).to redirect_to(root_path)
    follow_redirect!
    expect(response.body).to include('Acesso restrito ao administrador')
  end
end
